...
From here, you can check xref:deployment:operator-reference.adoc#reporting_metrics_to_prometheus[how to deploy your application using Akka Operator, and how it integrates with Prometheus].
